...
| **Proof** | IMPLEMENTED | generator+pipeline+B0/B1+A1–A4+DEGRADED proven ≤ n=120 smoke w/ bootstrap CIs; **official N=3000×3-seed×8-arm run EXECUTED 2026-08-24** under `eval-preregistered-v1` — artifacts committed at `eval/results/20260826T105147Z/` [SIMULATED] |
...
| Eval 3×3000+ablations <10min | ✅ EXECUTED 2026-08-24 | official run complete (3 seeds × 8 arms incl. A1–A4+DEGRADED); artifacts `eval/results/20260826T105147Z/` (`results.json` + `tables.md`); exact wall-clock not recorded in artifacts (protocol target <10 min for runs) |

...
**Version:** 1.0 · Terminology per `1. PRD.md` / `2. TechSpec.md`.
...
**Setup before start:** `make demo` running; demo slice **214 episodes / ₹2,41,000 failed value**, seed `demo-7`, speed ×100; naive-baseline arm running in parallel (same batch, visible as comparison counter); LLM healthy.
